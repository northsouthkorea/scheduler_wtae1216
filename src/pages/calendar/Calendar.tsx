...
class Calendar extends Component<CalendarPropsTypes>    {
    render()    {
        ...
        return (
            <CalendarWrap>
                <Switch>
                    <Route path={`${match.path}/month`} component={MonthCalendar}/>
                    <Route path={`${match.path}/week`} component={WeekCalendar}/>
    ...
    componentDidUpdate(prevProps: Readonly<CalendarPropsTypes>, prevState: Readonly<{}>, snapshot?: any)    {
        const { CalendarReducer, match } = this.props;
